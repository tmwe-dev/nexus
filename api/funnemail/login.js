...
module.exports=async function handler(req,res){
 ...
 try{const d=await login(email,password);return res.status(200).json({contract:'funnemail.auth.login.v1',access_token:d.access_token,refresh_token:d.refresh_token,expires_in:d.expires_in,expires_at:d.expires_at,user:d.user});}
