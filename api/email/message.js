...
module.exports=async function handler(req,res){
 ...
 try{
  if(service.configured()){const data=await service.request(req,`/messages/${encodeURIComponent(id)}`);return res.status(200).json({...data,source:'funnemail-service-boundary'});}
