...
const CAPABILITIES = Object.freeze([
  ...
  { name:'email.classify.v1', owner:'funnemail', route:'/api/email/classify', method:'POST', scope:'email:classify', status:'compatibility', side_effects:true, idempotency_required:true },
  { name:'email.reclassify.v1', owner:'funnemail', route:'/api/email/reclassify', method:'POST', scope:'email:classify', status:'compatibility', side_effects:true, idempotency_required:true },
