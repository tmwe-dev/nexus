...
const CAPABILITIES = Object.freeze([
  ...
  { name:'email.draft.list.v1', owner:'funnemail', route:'/api/email/drafts', method:'GET', scope:'email:read', status:'compatibility', side_effects:false, idempotency_required:false },
  ...
  { name:'email.draft.action.v2', owner:'funnemail', route:'/api/email/draft-action', method:'POST', scope:'email:write', status:'compatibility', side_effects:true, idempotency_required:false },
  ...
  { name:'email.reclassify.v1', owner:'funnemail', route:'/api/email/reclassify', method:'POST', scope:'email:classify', status:'compatibility', side_effects:true, idempotency_required:false },
  { name:'email.tasks.v2', owner:'funnemail', route:'/api/email/tasks', method:'GET', scope:'email:read', status:'compatibility', side_effects:false, idempotency_required:false },
  { name:'email.task.create.v2', owner:'funnemail', route:'/api/email/tasks', method:'POST', scope:'email:write', status:'compatibility', side_effects:true, idempotency_required:false },
  ...
  { name:'email.enrich.v1', owner:'funnemail', route:'/api/email/enrich', method:'POST', scope:'email:write', status:'compatibility', side_effects:true, idempotency_required:false },
